...
function consoleQrcode() {
  const styleText = `background:url('${qrcodeElement.querySelector('img').getAttribute('src')}') no-repeat; padding-bottom: ${imgElement.height}px; padding-left: ${imgElement.width}px`;
